    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prurl', models.URLField(blank=True, db_index=True, null=True, verbose_name='Pull request URL')),
                ('ciurl', models.URLField(blank=True, null=True, verbose_name='Continous Integration URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Use "-" for dividers', max_length=50)),
                ('icon', models.CharField(blank=True, help_text='see http://getbootstrap.com/components/#glyphicons-glyphs', max_length=100, null=True)),
